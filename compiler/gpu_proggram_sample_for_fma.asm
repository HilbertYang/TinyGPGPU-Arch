...
Loop:
    ...
    11  LD64        R12     R3      0       0      // R12 = MEM[R3]
    12  ADDI64      R1      R1      0       1      // R1 += 1;
    13  ADDI64      R2      R2      0       1      // R2 += 1;
    14  MAC_BF16    R12     R10     R11     0      // R12 = R11 * R10 + R12
    15  BR          0       0       0       Loop
    16  ADDI64      R5      R5      0       4      // R5 += 4;
    17  ST64        R12     R3      0       0      // MEM[R3] = R12(result)
    18  ADDI64      R3      R3      0       1      // R3 += 1;

RET:
    19  RET         0       0       0       0     //DONE CALCULATION